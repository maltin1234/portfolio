...
<html lang="en">
  <head>
    ...
    <title>Maltin Coku | A Web Developer based in Malmo, Sweden.</title>
      ...
      <div class="header__text-box row">
        <div class="header__text">
          <h1 class="heading-primary">
            ...
            <span>Maltin Coku</span>
          </h1>
          <!-- Put a small paragraph about yourself -->
          <p>A Web Developer based in Malmo, Sweden.</p>
      ...
      <div class="row">
        ...
        <ul class="footer__social-links">
          <li class="footer__social-link-item">
            <a
              href="https://github.com/maltin1234"
          ...
          <li class="footer__social-link-item">
            <a href="https://www.linkedin.com/in/maltin-coku-ab4c/">
              <img
